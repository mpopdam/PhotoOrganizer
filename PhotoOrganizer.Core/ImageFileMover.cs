...
internal class ImageFileMover : IImageFileMover
{
    ...
    private static string GetTargetImagePath(string targetFolder, ImageFile image)
    {
        ...
        string newFileName = $"{image.DateTaken:yyyyMMdd_HH_mm_ss}{Path.GetExtension(image.FilePath)}";
